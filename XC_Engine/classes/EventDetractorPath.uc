...
event Destroyed()
{
	...
	if ( OwnerEvent != None && !OwnerEvent.bDestroying && !OwnerEvent.bDeleteMe )
		OwnerEvent.RemoveDetractor( self);
	if ( EnablerEvent != None && !EnablerEvent.bDestroying && !EnablerEvent.bDeleteMe )
		EnablerEvent.RemoveDetractor( self);
